...
function bb_get_page_elements() {
    return array(
            ...
            'main_menu_background' => 'nav.top-bar, nav.top-bar ul',
            'main_menu_text' => 'nav .menu > li > a, nav .menu > li > a:hover',
            ...
            'button_hover_background' => 'button:hover, button:focus, .button:hover, .button:focus, a.button:link:hover, a.button:link:focus, input[type=submit]:hover, input[type=submit]:focus, .button.disabled:focus, .button.disabled:hover, .button[disabled]:focus, .button[disabled]:hover',
            'button_hover_text' => 'button:hover, button:focus, .button:hover, .button:focus, a.button:link:hover, a.button:link:focus, input[type=submit]:hover, input[type=submit]:focus, .button.disabled:focus, .button.disabled:hover, .button[disabled]:focus, .button[disabled]:hover',
